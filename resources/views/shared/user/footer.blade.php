<footer class="ftco-footer bg-light ftco-section d-print-none">
    <div class="container">
        <div class="row">
            <div class="mouse">
        ...
        <div class="row mb-5">
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    <h2 class="ftco-heading-2">{{config('sp.company')}}</h2>
                    <p>With Cure At your Door.</p>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <p>
                    Copyright &copy;{{date('Y')}} All rights reserved | &copy; {{config('sp.company')}}
                </p>
            </div>
        </div>
    </div>
