        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 ftco-animate">
                    ...
                    <p>
                        <img src="{{asset('public/user_asset/images/image_1.jpg')}}" alt="" class="img-fluid">
                    </p>
                    ...
                    <p>
                        <img src="{{asset('public/user_asset/images/image_2.jpg')}}" alt="" class="img-fluid">
                    </p>
                    ...
                    <div class="about-author d-flex p-4 bg-light">
                        <div class="bio align-self-md-center mr-4">
                            <img src="{{asset('public/user_asset/images/person_1.jpg')}}" alt="Image placeholder" class="img-fluid mb-4">
                        </div>
                    ...
                    <div class="pt-5 mt-5">
                        ...
                        <ul class="comment-list">
                            <li class="comment">
                                <div class="vcard bio">
                                    <img src="{{asset('public/user_asset/images/person_1.jpg')}}" alt="Image placeholder">
                                </div>
                            ...
                            <li class="comment">
                                <div class="vcard bio">
                                    <img src="({{asset('public/user_asset/images/image_2.jpg')}})" alt="Image placeholder">
                                </div>
                                <div class="comment-body">
                                    <h3>John Doe</h3>
                                    <div class="meta">June 27, 2018 at 2:21pm</div>
